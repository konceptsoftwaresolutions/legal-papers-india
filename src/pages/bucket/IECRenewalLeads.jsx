...
const IECRenewalLeads = () => {
  ...
  useEffect(() => {
    dispatch(getIECRenewalLeads(page, filters ? true : false, filters));
  }, [dispatch, page, filter, filters]);

  const { iecRenewalLeads, assignedNCLoader } = useSelector(
    (state) => state.leads
  );
  ...
  const handleSalesAssign = () => {
    ...
    dispatch(handleIECBulkSalesAssign(payload));
  };
  ...
  return (
    <>
      <LeadFilter
        ...
        filterFor="iecRenewalLead"
        onFilterSubmit={onFilterSubmit}
        endPoint="iec-renewal-lead"
      ...
      <div className="p-3">
        <div className="flex justify-between main-text items-center">
          <div className="flex justify-center items-center gap-x-3">
            ...
            <Heading text="IEC Renewal Leads" showHeading />
          </div>
          ...
          {assignedNCLoader ? (
            ...
            <>
              <DataTable
                ...
                data={iecRenewalLeads ? iecRenewalLeads.allLead : []}
        ...
        <Pagination
          totalPages={
            iecRenewalLeads ? Math.ceil(iecRenewalLeads.countAllLead / 10) : ""
          }
          currentPage={page}
...
export default IECRenewalLeads;
