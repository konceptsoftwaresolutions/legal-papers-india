...
import { getServiceCategoryStatusLeadsDataThreeMonthsThunkMiddleware, getServiceCategoryStatusLeadsDataUsedNCBucketThunkMiddleware } from "../../redux/features/bucket";
import { TiArrowForwardOutline } from "react-icons/ti";

const UsedNCBucketShare = () => {
  ...
  useEffect(() => {
    ...
    dispatch(
      getServiceCategoryStatusLeadsDataUsedNCBucketThunkMiddleware(payload)
    );
    ...
    <>
      ...
      <div className="flex flex-col w-full px-4 gap-y-4 py-5">
        <div className="grid grid-cols-2">
          <Heading text="Used NC Bucket Share by Selecting" showHeading />
        </div>
...
export default UsedNCBucketShare;
