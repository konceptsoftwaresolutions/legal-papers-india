...
import { sendWASampleMessage } from "../../../redux/features/marketing";

const SampleMsgModal = ({
  open,
  setOpen,
  setSubmitAction,
  currentFormData,
  ...
  const onSubmit = (data) => {
    ...
    dispatch(
      sendWASampleMessage(payload, setIsLoading, (success) => {
        if (success) {
          reset();
          handleCloseModal();
        }
