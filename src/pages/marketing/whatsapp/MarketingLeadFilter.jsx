...
const MarketingLeadFilter = ({
  ...
  // useEffect(() => {
  //   const savedFilters = sessionStorage.getItem("whatsappFilters");
  //   if (savedFilters) {
  //     const parsedFilters = JSON.parse(savedFilters);

  //     dispatch(
  //       getAllFilteredLeadIDs(parsedFilters, (success, data) => {
  //         if (success) {
  //           setFilteredLeads(data.leadIds);
  //         }
  //       })
  //     );
  //   }
...
export default MarketingLeadFilter;
