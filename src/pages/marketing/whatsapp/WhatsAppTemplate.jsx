...
import { createWhatsAppTemplate } from "../../../redux/features/marketing";
...
const WhatsAppTemplate = () => {
  ...
  const onSubmitHandler = (data) => {
    ...
    dispatch(
      createWhatsAppTemplate(payload, setIsLoading, (success) => {
        if (success) {
          navigate(-1);
        }
      })
  ...
  return (
    <div className="p-5">
      <Heading text="Create WhatsApp Template" showHeading />
